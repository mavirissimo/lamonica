( function( $, data ) {
	...
	var easyjetElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, easyjetElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, easyjetElementor.initCb );
		},
	...
	easyjetElementor.init();

}( jQuery, window.easyjetEditData ) );
