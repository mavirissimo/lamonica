...
if ( ! class_exists( 'Easyjet_Elementor' ) ) {

	/**
	 * Define Easyjet_Elementor class
	 */
	class Easyjet_Elementor {
		...
		public function edit_scripts() {
			...
			$js_core = easyjet_theme()->get_core()->modules['cherry-js-core'];
			$ui      = easyjet_theme()->get_core()->init_module( 'cherry-ui-elements' );
			$builder = easyjet_theme()->get_core()->init_module( 'cherry-interface-builder' );
			...
			wp_localize_script( 'easyjet-edit', 'easyjetEditData', $this->get_data() );
		...
		public function get_widgets() {
			...
			foreach ( $wp_widget_factory->widgets as $widget ) {
				...
				if ( false === strpos( $widget->widget_id, 'easyjet' ) ) {
					continue;
				}
...
/**
 * Returns instance of Easyjet_Elementor
 *
 * @return object
 */
function easyjet_elementor() {
	return Easyjet_Elementor::get_instance();
}
