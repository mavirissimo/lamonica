...
if ( ! class_exists( 'Easyjet_Widget_Area' ) ) {

	/**
	 * Class Easyjet_Widget_Area.
	 */
	class Easyjet_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'easyjet_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'easyjet_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'easyjet_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function easyjet_widget_area() {
		return Easyjet_Widget_Area::get_instance();
	}
