 ...
 */
add_filter( 'template_include', array( 'Easyjet_Wrapping', 'wrap' ), 99 );
add_filter( 'easyjet_wrap_base', 'easyjet_wrap_base_cpts' );
 ...
 */
function easyjet_template_path() {
	return Easyjet_Wrapping::$main_template;
}
 ...
 */
function easyjet_template_base() {
	return Easyjet_Wrapping::$base;
}

if ( ! class_exists( 'Easyjet_Wrapping' ) ) {
	...
	class Easyjet_Wrapping {
		...
		/**
		 * Initialize new instance of Easyjet_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'easyjet_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Easyjet_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function easyjet_wrap_base_cpts( $templates ) {
